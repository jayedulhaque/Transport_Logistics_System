...
namespace Transport.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260520013812_AddBranchPayoutDetails")]
    partial class AddBranchPayoutDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transport.Domain.Entities.AppConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Transport.Domain.Entities.BranchSettlementPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BranchSettlementPayments");
                });

            modelBuilder.Entity("Transport.Domain.Entities.DriverEarningsPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DriverEarningsPayments");
                });
            ...
            modelBuilder.Entity("Transport.Domain.Entities.DriverProfile", b =>
                {
                    ...
                    b.Property<decimal>("AccruedTripEarnings")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("PaidToDriver")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Transport.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Transport.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<decimal>("AmountReceivedAtDestination")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("AmountReceivedAtOrigin")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Transport.Domain.Entities.Trip", b =>
                {
                    ...
                    b.Property<bool>("EarningsCredited")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Transport.Domain.Entities.BranchSettlementPayment", b =>
                {
                    b.HasOne("Transport.Domain.Entities.User", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("Transport.Domain.Entities.User", "RecordedBy")
                        .WithMany()
